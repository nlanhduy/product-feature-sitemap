...
import { Edit, Trash2, Plus, Target, Lightbulb, FileText, List } from 'lucide-react'
        ...
        <SheetHeader>
          <SheetTitle className='flex items-center justify-between'>
            ...
            <div className='flex gap-2'>
              ...
              <Button size='sm' variant='outline' onClick={() => onAddChild(node.id)}>
